...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    array[i].years = splitYears;
    if (array[i].years[0] > 1900 && array[i].years[0] < 2000) {
      if (array[i].years[1] >= 1900 && array[i].years[1] < 2000) {
...
////console.log("=========================")
//console.log(removeArtist(artists, 17));
...
function addArtist(array) {
  const newObject = {
    ...
    bio: "Master artist of the famous NFT that was sold for more than Jeff Bezos. It was a picture of a durian taped to a wall."
  }
